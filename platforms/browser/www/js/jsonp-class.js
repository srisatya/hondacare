	   ...
	   var server=jsonp.server;	
        ...
        agenTerimaPesanan: function()
        {
          ...
          var arrdata=JSON.parse(DATAAGEN);
           ...
           var dataString="data="+JSON.stringify(arrdata);
        ...
        ubahStatusLayanan:function(prostatus,mekanik,callback)
        {
            ...
            var dataString ="orderid="+ORDERID+"&prostatus="+newstatus+"&username="+uname+"&password="+upass+"&mekanikid="+mekanik+"&deviceid="+DEVICEID+"&data_sp="+DATASP;
        ...
        agenMonitoringCall:function()
        {
            ...
            var server=jsonp.server;
            var akun=INTERNALDATA.akun.split(',');
            var dataString ="uname="+akun[0]+"&upass="+akun[1]+"&waktuagen="+WAKTUAGEN+"&mposition="+MONITORPOSITION;
           //alert(dataString);
